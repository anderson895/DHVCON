...
<!-- Hero Section -->
<main class="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white overflow-hidden min-h-screen flex flex-col justify-center">

  <!-- Decorative Circles -->
  <div class="absolute top-0 left-0 w-72 h-72 bg-purple-600 opacity-20 blur-3xl rounded-full animate-pulse-slow"></div>
  <div class="absolute bottom-0 right-0 w-96 h-96 bg-indigo-500 opacity-10 blur-3xl rounded-full animate-pulse-slow"></div>

  <!-- Content -->
  <section class="relative flex flex-col md:flex-row items-center justify-between px-8 lg:px-20 py-24 gap-16 z-10">
    ...
    <div class="max-w-xl space-y-6 text-center md:text-left animate-fade-in">
      ...
      <div class="flex justify-center md:justify-start pt-6">
        <a href="signin" class="flex items-center space-x-3 bg-indigo-600/90 backdrop-blur-md hover:bg-indigo-500 transition text-white px-8 py-4 rounded-full font-semibold shadow-2xl transform hover:scale-105">
...
.animate-fade-in-delay { animation: fadeIn 1s ease-out 0.3s forwards; }
