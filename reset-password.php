...
<main class="min-h-screen flex items-center justify-center bg-gray-900 text-white p-4">
    <div class="w-full max-w-md bg-[#1f2023]/80 backdrop-blur-xl border border-[#3c3f44] rounded-3xl shadow-2xl p-10 space-y-6">
        ...
        <!-- Step 2 Form: Reset Token + New Password -->
        <form id="frmResetToken" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative border border-[#3c3f44] bg-[#232428] rounded-2xl focus-within:ring-2 focus-within:ring-indigo-500 transition duration-300">
                    <input type="password" id="new_pass" class="w-full pl-4 pr-4 py-3 bg-transparent text-white focus:outline-none rounded-2xl placeholder-gray-500" placeholder="Enter new password" required>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative border border-[#3c3f44] bg-[#232428] rounded-2xl focus-within:ring-2 focus-within:ring-indigo-500 transition duration-300">
                    <input type="password" id="confirm_pass" class="w-full pl-4 pr-4 py-3 bg-transparent text-white focus:outline-none rounded-2xl placeholder-gray-500" placeholder="Confirm new password" required>
                </div>
            </div>
